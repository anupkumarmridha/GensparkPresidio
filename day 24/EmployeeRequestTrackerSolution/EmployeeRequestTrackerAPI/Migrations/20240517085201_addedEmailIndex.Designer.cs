...
namespace EmployeeRequestTrackerAPI.Migrations
{
    ...
    [Migration("20240517085201_addedEmailIndex")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeRequestTrackerAPI.Models.DBModels.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeRequestTrackerAPI.Models.DBModels.Request", b =>
                {
            ...
            modelBuilder.Entity("EmployeeRequestTrackerAPI.Models.DBModels.RequestSolution", b =>
                {
            ...
            modelBuilder.Entity("EmployeeRequestTrackerAPI.Models.DBModels.SolutionFeedback", b =>
                {
            ...
            modelBuilder.Entity("EmployeeRequestTrackerAPI.Models.DBModels.User", b =>
                {
            ...
            modelBuilder.Entity("EmployeeRequestTrackerAPI.Models.DBModels.Request", b =>
                {
                    b.HasOne("EmployeeRequestTrackerAPI.Models.DBModels.Employee", "RequestClosedByEmployee")
                        .WithMany("RequestsClosed")
                        .HasForeignKey("RequestClosedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EmployeeRequestTrackerAPI.Models.DBModels.Employee", "RaisedByEmployee")
            ...
            modelBuilder.Entity("EmployeeRequestTrackerAPI.Models.DBModels.RequestSolution", b =>
                {
                    b.HasOne("EmployeeRequestTrackerAPI.Models.DBModels.Request", "RequestRaised")
                        .WithMany("RequestSolutions")
                        .HasForeignKey("RequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EmployeeRequestTrackerAPI.Models.DBModels.Employee", "SolvedByEmployee")
            ...
            modelBuilder.Entity("EmployeeRequestTrackerAPI.Models.DBModels.SolutionFeedback", b =>
                {
                    b.HasOne("EmployeeRequestTrackerAPI.Models.DBModels.Employee", "FeedbackByEmployee")
                        .WithMany("FeedbacksGiven")
                        .HasForeignKey("FeedbackBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EmployeeRequestTrackerAPI.Models.DBModels.RequestSolution", "Solution")
                        .WithMany("Feedbacks")
            ...
            modelBuilder.Entity("EmployeeRequestTrackerAPI.Models.DBModels.User", b =>
                {
                    b.HasOne("EmployeeRequestTrackerAPI.Models.DBModels.Employee", "Employee")
                        .WithMany()
